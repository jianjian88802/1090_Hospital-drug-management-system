    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="取药数量" prop="quyaojiluNumber">
                       <el-input v-model="ruleForm.quyaojiluNumber"
                                 placeholder="取药数量" clearable  :readonly="ro.quyaojiluNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="取药数量" prop="quyaojiluNumber">
                           <el-input v-model="ruleForm.quyaojiluNumber"
                                     placeholder="取药数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="quyaojiluTypes">
                        <el-select v-model="ruleForm.quyaojiluTypes" :disabled="ro.quyaojiluTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in quyaojiluTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="类型" prop="quyaojiluValue">
                        <el-input v-model="ruleForm.quyaojiluValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    yonghuId: false,
                    yuangongId: false,
                    quyaojiluNumber: false,
                    quyaojiluTypes: false,
                    quyaojiluDelete: false,
                },
                ruleForm: {
                    yaopinId: '',
                    yonghuId: '',
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=quyaojilu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.quyaojiluTypesOptions = data.data.list;
                    }
                });
