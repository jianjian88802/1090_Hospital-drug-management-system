        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="药品单位" prop="danweiTypes">
                        <el-select v-model="ruleForm.danweiTypes" :disabled="ro.danweiTypes" placeholder="请选择药品单位">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="药品单位" prop="danweiValue">
